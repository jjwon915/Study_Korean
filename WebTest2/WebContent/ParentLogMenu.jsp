...
<body>
	...
	<div class="menubar" id="nav">
		<ul class="menu">
			<li><a href="ParentHome.jsp" class="home">Home</a></li>
			<li><a href="Logout.jsp" id="current">로그아웃</a>
			<li><a href="ChildManage.jsp">아이관리</a></li>
			<li><a href="#">학습판관리</a>
				<ul class="sub">
					<li><a href="MakeImage.jsp">만들기</a></li>
					<li><a href="StudyList.jsp">리스트</a></li>
				</ul></li>
			<li><a href="GoMypage.jsp">MyPage</a></li>
		</ul>
	</div>
