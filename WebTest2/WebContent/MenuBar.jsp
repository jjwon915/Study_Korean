...
<body>
	...
	<div class="menubar" id="nav">
		<ul class="menu">
			<li><a href="Home.jsp" class="home" class="home">Home</a></li>
			<li><a href="#" class="login">로그인</a>
				<ul class="sub">
					<li><a href="ChildLogin.jsp">아이 로그인</a></li>
					<li><a href="ParentLogin.jsp">보호자 로그인</a></li>
				</ul></li>
			<li><a href="Join.jsp">회원가입</a></li>
		</ul>
	</div>
	<div class="menubar2" id="nav2" style="display: none">
		<ul class="menu2">
			<li><a href="Home.jsp" class="home" class="home">Home</a></li>
			<li><a href="#" class="login">로그인</a>
				<ul class="sub">
