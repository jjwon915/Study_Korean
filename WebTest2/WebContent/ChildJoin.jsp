...
<script type="text/javascript">
	function openIdChk() {
		window.name = "idForm";
		window.open("checkChildForm.jsp", "chkForm",
...
<body>
	...
	<div class="join-page">
		<div class="form">
			<p align="center" class="main_message">아이 등록 페이지</p>
			<form class="register-form" method="POST" action="doChildJoin"
				name="join" id="join">
				...
				<input type="hidden" id="parentId" name="parentId"
					value="<%=session.getAttribute("parentId")%>"> <input
					type="hidden" id="idDuplication" name="idDuplication"
					value="unCheck">
				<button onclick="return checkValue();">등록하기</button>
			</form>
		</div>
	</div>
</body>
