...
<script>
	...
	function drag(ev) {
		var code = '<img src="'
				+ ev.target.src
				+ '" width="150" height="150" ondrop="drop(event)" ondragover="allowDrop(event)"  ondragenter="return false"> <p></p>';
		...
		<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
			...
			<%
				...
				try {
					...
					int id = Integer.parseInt(request.getParameter("category2"));
					String query = "select * from symbol where symbol_category_id = any(select category_id from category where category_parent_id = "
							+ id + ")";
					// 2. 데이터베이스 커넥션 생성
